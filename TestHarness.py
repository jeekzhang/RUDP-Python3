...
import Checksum
from tests import BasicTest, CombinationTest
...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, DisorderTest, SackDisorderTest, RepeatTest, SackRepeatTest, CombinationTest, SackCombinationTest
    ...
    SackRepeatTest.SackRepeatTest(forwarder, "README")
    CombinationTest.CombinationTest(forwarder, "pic_test.jpeg")
    SackCombinationTest.SackCombinationTest(forwarder, "turn-on-off.mp4")
